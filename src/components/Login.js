...
const Login = () => {
    const [email, setEmail] = useState("stk@gmail.com");
            ...
            <section id={"login"} className={"min-h-screen grid grid-cols-12 gap-4 relative"}>
                ...
                <div className="col-span-4 px-[70px] pt-[200px] bg-white">
                    <div className={'absolute right-1 top-5 flex items-center'}>
                        <h1>New User ?</h1>
                        <Link to={"/register"}
                              className={`bg-blue-500 font-bold text-white px-[10px] py-[10px] ml-2 rounded-md`}>GET
                            STARTED NOW !</Link>
                    </div>
                    <h1 className={`text-black text-[30px] leading-[34px] font-bold text-center`}>Hi, Welcome Back
                        !</h1>
